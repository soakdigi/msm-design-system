// MSM icon set — Lucide-style line icons (1.85 stroke). See README for substitution note.
const MSM_ICON_PATHS = {
  ...
  truck: '<path d="M14 18V6a1 1 0 0 0-1-1H3a1 1 0 0 0-1 1v11a1 1 0 0 0 1 1h2"/><path d="M14 9h4l4 4v4a1 1 0 0 1-1 1h-1"/><circle cx="7.5" cy="18" r="2"/><circle cx="17.5" cy="18" r="2"/>',
...
function Icon({ name, className, style }) {
  return (
    <svg className={className} style={style} xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.85"
      strokeLinecap="round" strokeLinejoin="round"
      dangerouslySetInnerHTML={{ __html: MSM_ICON_PATHS[name] || '' }} />
  );
}
window.Icon = Icon;
